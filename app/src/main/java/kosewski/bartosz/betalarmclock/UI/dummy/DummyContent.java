package kosewski.bartosz.betalarmclock.UI.dummy;
...
public class DummyContent {
    ...
    private static Alarm createDummyItem(int position) {
        return new Alarm(String.valueOf(position), "Item " + position, makeDetails(position));
    }
